...
const dict = {
  lt: {
    ...
    adminAccessError: "Nepavyko patikrinti prieigos. Patikrinkite interneto ryšį ir bandykite dar kartą.",
    loading: "Kraunama…",
  ...
  en: {
    ...
    adminAccessError: "Access could not be checked. Check your connection and try again.",
    loading: "Loading…",
